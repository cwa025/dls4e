			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nszrestv3-display": {
								"semanticObject": "nszrestv3",
								"action": "display",
								"description": "RESTUrlaub App Version3",
								"title": "RESTUrlaub V3",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.zrestv3",
									"url": sap.ui.require.toUrl("ns/zrestv3")
								}
							}
						}
					}
